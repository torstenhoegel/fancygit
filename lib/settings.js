...
// Path to settings.json file in .fancygit directory
const settingsFile = path.resolve(process.cwd(), '.fancygit/settings.json');

// Path to formats.json file in .fancygit directory
